...
namespace Infrastructure.EndPoint.Migrations
{
    ...
    [Migration("20200609120357_2003-3")]
    partial class _20033
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mobile = "09130097415",
                            Name = "مدیر",
                            Password = "DV078mypL+QeQsrq/zMgLVADsf/Grzf86QjNMCGItN+HRr/1HlqzdQ==",
                            Salt = "mlYdHkX1WVa3Q05CsxYcRX2jCyqEFU5HZEOfWAfy8dajcwqtghSWzw==",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.Bill", b =>
                {
                    b.HasOne("Core.Entities.RegisteredTable", "RegisteredTable")
                        .WithMany("Bill")
            ...
            modelBuilder.Entity("Core.Entities.Message", b =>
                {
                    b.HasOne("Core.Entities.User", "From")
                        .WithMany("MyMessage")
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Core.Entities.User", "To")
