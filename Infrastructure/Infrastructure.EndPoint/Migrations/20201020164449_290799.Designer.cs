...
namespace Infrastructure.EndPoint.Migrations
{
    ...
    [Migration("20201020164449_290799")]
    partial class _290799
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.BarginCampaign", b =>
                {
                    ...
                    b.Property<bool?>("IsProductDiscount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entities.BarginUserBills", b =>
                {
                    b.Property<Guid>("BarginUsersId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BillId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BarginUsersId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("BarginUsersId", "BillId");

                    b.HasIndex("BarginUsersId1")
                        .IsUnique()
                        .HasFilter("[BarginUsersId1] IS NOT NULL");

                    b.HasIndex("BillId");

                    b.HasIndex("BillId1");

                    b.ToTable("BarginUserBills");
                });
            ...
            modelBuilder.Entity("Core.Entities.BillGames", b =>
                {
                    ...
                    b.Property<int>("UnitPriceFirstHour")
                        .HasColumnType("int");

                    b.Property<int>("UnitPriceOtherHour")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.GameType", b =>
                {
                    ...
                    b.Property<int>("PricePerFirstHour")
                        .HasColumnType("int");

                    b.Property<int>("PricePerOtherhour")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.LastDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("BuyingValue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Description = "مبلغ خرید در این تعداد روز برای تعلق جایزه",
                            Name = "DaysForLoyalty",
                            Value = "30"
                        },
                        new
                        {
                            Id = 4,
                            Description = "میزان خرید برای جایزه",
                            Name = "BuyingForLoyalty",
                            Value = "100000"
                        },
                        new
                        {
                            Id = 5,
                            Description = "جایزه برای خرید بیش از یک مقداری",
                            Name = "RewardForLoyalty",
                            Value = "5000"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mobile = "09130097415",
                            Name = "مدیر",
                            Password = "97spmwYhSgb4PqKaVre1oHSkAHBJMQMEFxiIaEziEaDUsHLMQ201Ig==",
                            Salt = "GztYdf1x65t33jQwA12WKXwDzyqd3uTaitLGcIBbmL7YJhz9+a0elw==",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.BarginUserBills", b =>
                {
                    b.HasOne("Core.Entities.BarginUsers", "BarginUsers")
                        .WithMany()
                        .HasForeignKey("BarginUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.BarginUsers", null)
                        .WithOne("BarginUserBills")
                        .HasForeignKey("Core.Entities.BarginUserBills", "BarginUsersId1");
