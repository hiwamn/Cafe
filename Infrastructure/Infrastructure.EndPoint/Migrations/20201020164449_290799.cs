...
{
    public partial class _290799 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyingValue = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LastDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LastDiscounts_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, "جایزه برای خرید بیش از یک مقداری", "RewardForLoyalty", "5000" },
                    { 4, "میزان خرید برای جایزه", "BuyingForLoyalty", "100000" },
                    { 3, "مبلغ خرید در این تعداد روز برای تعلق جایزه", "DaysForLoyalty", "30" }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "97spmwYhSgb4PqKaVre1oHSkAHBJMQMEFxiIaEziEaDUsHLMQ201Ig==", "GztYdf1x65t33jQwA12WKXwDzyqd3uTaitLGcIBbmL7YJhz9+a0elw==" });

            migrationBuilder.CreateIndex(
                name: "IX_LastDiscounts_UserId",
                table: "LastDiscounts",
                column: "UserId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("8114eb2e-3588-4239-98a4-f7e3023674e8"),
                columns: new[] { "Password", "Salt" },
                values: new object[] { "Uy0QL0wqgfoK+vb5a34s10zq6+Bohak3MWdnHdP17uks9QZ8NQB3dg==", "Q/FxoETeTXzoZbB3BsIU1BEaYwvOr7WL6qKUwu7fIq+gCCeotDzKOg==" });
        }
    }
}
