...
namespace Infrastructure.EndPoint.Controllers
{
    public class AdminController : SimpleController
    {
        ...
        private readonly IChangeUserToAccountant changeUserToAccountant;
        ...
        public AdminController(
            ...
            IChangeUserToAccountant changeUserToAccountant
            )
        {
            ...
            this.changeUserToAccountant = changeUserToAccountant;
        }
        ...
        [HttpPost]
        public ActionResult<BaseApiResult> ChangeUserToAccountant([FromBody] ChangeUserToAccountantDto dto)
        {
            return changeUserToAccountant.Execute(dto);
        }
    }
}
